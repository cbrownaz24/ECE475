//=========================================================================
// 7-Stage RISCV Control Unit with Pipelined MulDiv
//=========================================================================
...
(
  ...
  output reg       muldiv_mux_sel_Whl,
  output reg       execute_mux_sel_Whl,
  ...
  wire [2:0] muldivreq_msg_fn_Dhl_cs = cs[`RISCV_INST_MSG_MULDIV_FN];
  assign muldivreq_msg_fn_Dhl = muldivreq_msg_fn_Dhl_cs;
  ...
  always @ ( posedge clk ) begin
    if ( reset ) begin
      ...
      if ( !stall_Xhl )  is_muldiv_Xhl  <= is_muldiv_Dhl;
      if ( !stall_Mhl )  is_muldiv_Mhl  <= is_muldiv_Xhl;
      if ( !stall_X2hl ) is_muldiv_X2hl <= is_muldiv_Mhl;
      if ( !stall_X3hl ) is_muldiv_X3hl <= is_muldiv_X2hl;
    end
  end

  wire rs1_X_byp_Dhl = inst_val_Dhl && rs1_en_Dhl
                    && inst_val_Xhl && rf_wen_Xhl
                    && ( rs1_addr_Dhl == rf_waddr_Xhl )
                    && ( rf_waddr_Xhl != 5'd0 );

  wire rs1_M_byp_Dhl = inst_val_Dhl && rs1_en_Dhl
                    && inst_val_Mhl && rf_wen_Mhl
                    && ( rs1_addr_Dhl == rf_waddr_Mhl )
                    && ( rf_waddr_Mhl != 5'd0 );

  wire rs1_X2_byp_Dhl = inst_val_Dhl && rs1_en_Dhl
                     && inst_val_X2hl && rf_wen_X2hl
                     && ( rs1_addr_Dhl == rf_waddr_X2hl )
                     && ( rf_waddr_X2hl != 5'd0 );

  wire rs1_X3_byp_Dhl = inst_val_Dhl && rs1_en_Dhl
                     && inst_val_X3hl && rf_wen_X3hl
                     && ( rs1_addr_Dhl == rf_waddr_X3hl )
                     && ( rf_waddr_X3hl != 5'd0 );

  wire rs1_W_byp_Dhl = inst_val_Dhl && rs1_en_Dhl
                    && inst_val_Whl && rf_wen_Whl
                    && ( rs1_addr_Dhl == rf_waddr_Whl )
                    && ( rf_waddr_Whl != 5'd0 );

  wire rs2_X_byp_Dhl = inst_val_Dhl && rs2_en_Dhl
                    && inst_val_Xhl && rf_wen_Xhl
                    && ( rs2_addr_Dhl == rf_waddr_Xhl )
                    && ( rf_waddr_Xhl != 5'd0 );

  wire rs2_M_byp_Dhl = inst_val_Dhl && rs2_en_Dhl
                    && inst_val_Mhl && rf_wen_Mhl
                    && ( rs2_addr_Dhl == rf_waddr_Mhl )
                    && ( rf_waddr_Mhl != 5'd0 );

  wire rs2_X2_byp_Dhl = inst_val_Dhl && rs2_en_Dhl
                     && inst_val_X2hl && rf_wen_X2hl
                     && ( rs2_addr_Dhl == rf_waddr_X2hl )
                     && ( rf_waddr_X2hl != 5'd0 );

  wire rs2_X3_byp_Dhl = inst_val_Dhl && rs2_en_Dhl
                     && inst_val_X3hl && rf_wen_X3hl
                     && ( rs2_addr_Dhl == rf_waddr_X3hl )
                     && ( rf_waddr_X3hl != 5'd0 );

  wire rs2_W_byp_Dhl = inst_val_Dhl && rs2_en_Dhl
                    && inst_val_Whl && rf_wen_Whl
                    && ( rs2_addr_Dhl == rf_waddr_Whl )
                    && ( rf_waddr_Whl != 5'd0 );

  assign rs1_byp_sel_Dhl = rs1_X_byp_Dhl  ? 3'd1 :
                           rs1_M_byp_Dhl  ? 3'd2 :
                           rs1_X2_byp_Dhl ? 3'd3 :
                           rs1_X3_byp_Dhl ? 3'd4 :
                           rs1_W_byp_Dhl  ? 3'd5 : 3'd0;

  assign rs2_byp_sel_Dhl = rs2_X_byp_Dhl  ? 3'd1 :
                           rs2_M_byp_Dhl  ? 3'd2 :
                           rs2_X2_byp_Dhl ? 3'd3 :
                           rs2_X3_byp_Dhl ? 3'd4 :
                           rs2_W_byp_Dhl  ? 3'd5 : 3'd0;
  ...
  // Muldiv-use stall: must stall D for muldiv in X, M, X2, and X3
  // because the muldiv result is not available until W (after execute_mux)
  ...
  reg        bubble_Xhl;
  reg        muldiv_mux_sel_Xhl_r;
  reg        execute_mux_sel_Xhl_r;
  ...
  always @ ( posedge clk ) begin
    if ( reset ) begin
      ...
      muldiv_mux_sel_Xhl_r   <= muldiv_mux_sel_Dhl;
      execute_mux_sel_Xhl_r  <= execute_mux_sel_Dhl;
  ...
  wire any_br_taken_Xhl = beq_taken_Xhl || bne_taken_Xhl || blt_taken_Xhl
                       || bge_taken_Xhl || bltu_taken_Xhl || bgeu_taken_Xhl;
  ...
  reg        bubble_Mhl;
  reg        muldiv_mux_sel_Mhl_r;
  reg        execute_mux_sel_Mhl_r;
  ...
  always @ ( posedge clk ) begin
    if ( reset ) begin
      ...
      muldiv_mux_sel_Mhl_r   <= muldiv_mux_sel_Xhl_r;
      execute_mux_sel_Mhl_r  <= execute_mux_sel_Xhl_r;
  ...
  reg        bubble_X2hl;
  reg        muldiv_mux_sel_X2hl_r;
  reg        execute_mux_sel_X2hl_r;
  ...
  always @ ( posedge clk ) begin
    if ( reset ) begin
      ...
      muldiv_mux_sel_X2hl_r   <= muldiv_mux_sel_Mhl_r;
      execute_mux_sel_X2hl_r  <= execute_mux_sel_Mhl_r;
  ...
  always @ ( posedge clk ) begin
    if ( reset ) begin
      ...
      muldiv_mux_sel_Whl  <= muldiv_mux_sel_X2hl_r;
      execute_mux_sel_Whl <= execute_mux_sel_X2hl_r;
...
//========================================================================
  ...
  riscv_InstMsgDisasm inst_msg_disasm_D  ( .msg ( ir_Dhl   ) );
  riscv_InstMsgDisasm inst_msg_disasm_X  ( .msg ( ir_Xhl   ) );
  riscv_InstMsgDisasm inst_msg_disasm_M  ( .msg ( ir_Mhl   ) );
  riscv_InstMsgDisasm inst_msg_disasm_X2 ( .msg ( ir_X2hl  ) );
  riscv_InstMsgDisasm inst_msg_disasm_X3 ( .msg ( ir_X3hl  ) );
  riscv_InstMsgDisasm inst_msg_disasm_W  ( .msg ( ir_Whl   ) );
  riscv_InstMsgDisasm inst_msg_disasm_debug ( .msg ( ir_debug ) );
