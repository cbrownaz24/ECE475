...
(
  ...
  // Stall in F if D is stalled OR if we are holding for alternating issue
  ...
  //----------------------------------------------------------------------
  // Use stall_Fhl so responses are captured during toggle holds too
  ...
  always @ ( posedge clk ) begin
    if ( reset ) begin
      ...
      // Squash always forces D to become a bubble
      if ( squash_Dhl )
        bubble_Dhl <= 1'b1;
      else if ( !stall_Fhl )
        bubble_Dhl <= bubble_next_Fhl;

      // IR registers held during toggle hold (stall_Fhl)
      if ( !stall_Fhl ) begin
  ...
  always @(posedge clk) begin
    if ( reset || squash_Dhl || brj_taken_Dhl ) begin
      steering_toggle <= 1'b0;
    end
    else if ( inst_val_Dhl && !stall_Dhl ) begin
      steering_toggle <= ~steering_toggle;
    end
  end

  assign steering_mux_sel_Dhl = steering_toggle;

  // Stall front-end when on first instruction of a pair (hold ir1 for next cycle)
  wire stall_0_Dhl = (steering_mux_sel_Dhl == 1'b0)
                   && inst_val_Dhl
                   && !brj_taken_Dhl
                   && !squash_Dhl;
  ...
  wire [4:0] rsA2_addr_Dhl = instA_rs2_steer;
  wire       rsA1_en_Dhl   = csA[`RISCV_INST_MSG_RS1_EN];
  wire       rsA2_en_Dhl   = csA[`RISCV_INST_MSG_RS2_EN];

  // Bypass from pipeline A stages

  wire rs1_AX0_byp = rsA1_en_Dhl && rf0_wen_X0hl && (rsA1_addr_Dhl == rf0_waddr_X0hl) && (rf0_waddr_X0hl != 5'd0) && inst_val_X0hl;
  wire rs1_AX1_byp = rsA1_en_Dhl && rf0_wen_X1hl && (rsA1_addr_Dhl == rf0_waddr_X1hl) && (rf0_waddr_X1hl != 5'd0) && inst_val_X1hl;
  wire rs1_AX2_byp = rsA1_en_Dhl && rf0_wen_X2hl && (rsA1_addr_Dhl == rf0_waddr_X2hl) && (rf0_waddr_X2hl != 5'd0) && inst_val_X2hl;
  wire rs1_AX3_byp = rsA1_en_Dhl && rf0_wen_X3hl && (rsA1_addr_Dhl == rf0_waddr_X3hl) && (rf0_waddr_X3hl != 5'd0) && inst_val_X3hl;
  wire rs1_AW_byp  = rsA1_en_Dhl && rf0_wen_Whl  && (rsA1_addr_Dhl == rf0_waddr_Whl)  && (rf0_waddr_Whl  != 5'd0) && inst_val_Whl;

  wire rs2_AX0_byp = rsA2_en_Dhl && rf0_wen_X0hl && (rsA2_addr_Dhl == rf0_waddr_X0hl) && (rf0_waddr_X0hl != 5'd0) && inst_val_X0hl;
  wire rs2_AX1_byp = rsA2_en_Dhl && rf0_wen_X1hl && (rsA2_addr_Dhl == rf0_waddr_X1hl) && (rf0_waddr_X1hl != 5'd0) && inst_val_X1hl;
  wire rs2_AX2_byp = rsA2_en_Dhl && rf0_wen_X2hl && (rsA2_addr_Dhl == rf0_waddr_X2hl) && (rf0_waddr_X2hl != 5'd0) && inst_val_X2hl;
  wire rs2_AX3_byp = rsA2_en_Dhl && rf0_wen_X3hl && (rsA2_addr_Dhl == rf0_waddr_X3hl) && (rf0_waddr_X3hl != 5'd0) && inst_val_X3hl;
  wire rs2_AW_byp  = rsA2_en_Dhl && rf0_wen_Whl  && (rsA2_addr_Dhl == rf0_waddr_Whl)  && (rf0_waddr_Whl  != 5'd0) && inst_val_Whl;

  // Operand Bypass Mux Select

  assign opA0_byp_mux_sel_Dhl
    = (rs1_AX0_byp) ? am_AX0_byp
    : (rs1_AX1_byp) ? am_AX1_byp
    : (rs1_AX2_byp) ? am_AX2_byp
    : (rs1_AX3_byp) ? am_AX3_byp
    : (rs1_AW_byp)  ? am_AW_byp
    :                  am_r0;

  assign opA1_byp_mux_sel_Dhl
    = (rs2_AX0_byp) ? bm_AX0_byp
    : (rs2_AX1_byp) ? bm_AX1_byp
    : (rs2_AX2_byp) ? bm_AX2_byp
    : (rs2_AX3_byp) ? bm_AX3_byp
  ...
  // Stall in D if muldiv result is not ready

  wire stall_muldiv_use_Dhl = inst_val_Dhl && (
      ( inst_val_X0hl && rsA1_en_Dhl && rf0_wen_X0hl && ( rsA1_addr_Dhl == rf0_waddr_X0hl ) && ( rf0_waddr_X0hl != 5'd0 ) && is_muldiv_X0hl )
   || ( inst_val_X1hl && rsA1_en_Dhl && rf0_wen_X1hl && ( rsA1_addr_Dhl == rf0_waddr_X1hl ) && ( rf0_waddr_X1hl != 5'd0 ) && is_muldiv_X1hl )
   || ( inst_val_X2hl && rsA1_en_Dhl && rf0_wen_X2hl && ( rsA1_addr_Dhl == rf0_waddr_X2hl ) && ( rf0_waddr_X2hl != 5'd0 ) && is_muldiv_X2hl )
   || ( inst_val_X3hl && rsA1_en_Dhl && rf0_wen_X3hl && ( rsA1_addr_Dhl == rf0_waddr_X3hl ) && ( rf0_waddr_X3hl != 5'd0 ) && is_muldiv_X3hl )
   || ( inst_val_X0hl && rsA2_en_Dhl && rf0_wen_X0hl && ( rsA2_addr_Dhl == rf0_waddr_X0hl ) && ( rf0_waddr_X0hl != 5'd0 ) && is_muldiv_X0hl )
   || ( inst_val_X1hl && rsA2_en_Dhl && rf0_wen_X1hl && ( rsA2_addr_Dhl == rf0_waddr_X1hl ) && ( rf0_waddr_X1hl != 5'd0 ) && is_muldiv_X1hl )
   || ( inst_val_X2hl && rsA2_en_Dhl && rf0_wen_X2hl && ( rsA2_addr_Dhl == rf0_waddr_X2hl ) && ( rf0_waddr_X2hl != 5'd0 ) && is_muldiv_X2hl )
   || ( inst_val_X3hl && rsA2_en_Dhl && rf0_wen_X3hl && ( rsA2_addr_Dhl == rf0_waddr_X3hl ) && ( rf0_waddr_X3hl != 5'd0 ) && is_muldiv_X3hl )
  );

  // Stall for load-use hazard

  wire stall_load_use_Dhl = inst_val_Dhl && (
      ( inst_val_X0hl && rsA1_en_Dhl && rf0_wen_X0hl && ( rsA1_addr_Dhl == rf0_waddr_X0hl ) && ( rf0_waddr_X0hl != 5'd0 ) && is_load_X0hl )
   || ( inst_val_X1hl && rsA1_en_Dhl && rf0_wen_X1hl && ( rsA1_addr_Dhl == rf0_waddr_X1hl ) && ( rf0_waddr_X1hl != 5'd0 ) && is_load_X1hl )
   || ( inst_val_X0hl && rsA2_en_Dhl && rf0_wen_X0hl && ( rsA2_addr_Dhl == rf0_waddr_X0hl ) && ( rf0_waddr_X0hl != 5'd0 ) && is_load_X0hl )
   || ( inst_val_X1hl && rsA2_en_Dhl && rf0_wen_X1hl && ( rsA2_addr_Dhl == rf0_waddr_X1hl ) && ( rf0_waddr_X1hl != 5'd0 ) && is_load_X1hl )
  );

  // Aggregate Stall Signal (real hazards only — stall_0_Dhl is separate)

  assign stall_Dhl = (stall_X0hl || stall_muldiv_use_Dhl || stall_load_use_Dhl);

  // Next bubble bit for D→X0 transition
  ...
  assign rfB_wen_out_Whl = 1'b0;   // pipeline B unused in Part 1
